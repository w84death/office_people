![Office People](zig-cpu/docs/titlescreen.png)

## Office People for Firefox OS/Linux&Windows Desktops
...
Game have old school pixel art graphics. All done in 16 colors pallete and 16x16 sprites. 

## firefox-os
It's mainly developer for Firefox OS but works on all HTML5 capable devices.

## zig-cpu
Modern, Zig rewrite on Borowik Engine. For Windows and Linux Desktops.
